...
int main(void) {
	...
	HAL_GPIO_Init(GPIOI, &led1);

	__HAL_RCC_GPIOB_CLK_ENABLE();

	button1.Pin = GPIO_PIN_4;
	button1.Pull = GPIO_PULLDOWN;
	button1.Speed = GPIO_SPEED_FAST;
	button1.Mode = GPIO_MODE_IT_RISING;
	HAL_GPIO_Init(GPIOB, &button1);

	HAL_NVIC_SetPriority(EXTI4_IRQn, 0x2F, 0x00);
