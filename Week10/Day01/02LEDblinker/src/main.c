...
int main(void)
{
    ...
    tim_handle1.Init.Period            = 45000;
    tim_handle1.Init.Prescaler         = 32400;
    ...
    tim_oc1.OCMode = TIM_OCMODE_PWM1;
    tim_oc1.Pulse = 10;
    HAL_TIM_PWM_ConfigChannel(&tim_handle2, &tim_oc1, TIM_CHANNEL_1);
    ...
    tim_handle2.Init.Period            = 45000;
    tim_handle2.Init.Prescaler         = 32400;
    ...
    tim_handle3.Init.Period            = 45000;
    tim_handle3.Init.Prescaler         = 32400;
    ...
    while (1) {
        ...
        if (cnt2 == 15000 || cnt2 == 40000){
        	 HAL_GPIO_WritePin(GPIOF, GPIO_PIN_9, GPIO_PIN_SET);
        }else if (cnt2 == 20000 || cnt2 == 0){
